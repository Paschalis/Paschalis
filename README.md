...
3. <summary><strong><span style="background: #4caf50; color: white; padding: 3px 10px; border-radius: 15px;">MCU Morse Code Decoder</span></strong></summary>
...
3. <summary><strong><span style="background: #4caf50; color: white; padding: 3px 10px; border-radius: 15px;">Hardware Login Key </strong></summary>
...
1. <summary><strong><span style="background: #4caf50; color: white; padding: 3px 10px; border-radius: 15px;">Agriculture Sensor Integration Project</strong></summary>
 ...
 2. <summary><strong><span style="background: #4caf50; color: white; padding: 3px 10px; border-radius: 15px;">STM32 Info Monitor</strong></summary>
